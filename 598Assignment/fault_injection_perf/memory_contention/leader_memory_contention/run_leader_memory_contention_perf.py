...
print("Fault injection: leader memory contention")
...
for i in range(2, 22, 2):
    ...
    print("memory contention - leader ... ")
    command_leader_memory_contention = ["bash", "leader_memory_contention.sh", str(process_pid)]
    process_leader_memory_contention = subprocess.Popen(command_leader_memory_contention, stdout = subprocess.PIPE, stderr = subprocess.PIPE)
    out, err = process_leader_memory_contention.communicate()
    if err:
        print("ERR: ", err)
